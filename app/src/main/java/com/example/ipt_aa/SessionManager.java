...
public class SessionManager {
    ...
    public static final String KEY_TOKEN_BEARER = "token";
    ...
    public void createLoginSession(String name, String token) {
        ...
        editor.putString(KEY_TOKEN_BEARER, token);
    ...
    public HashMap<String, String> getUserDetails() {
        ...
        // user email id
        user.put(KEY_TOKEN_BEARER, pref.getString(KEY_TOKEN_BEARER, null));
